...
class SparkConfSetter {
    ...
    private static final String MASTER = "spark://192.168.0.103:7077";
    ...
    private static final String MASTER_IP = "192.168.0.103";
    private static final String NUMBER_OF_SPLITS = "32";
